//Synchronization is used to avoid data inconsistency.
...
public class Account implements Bank {
	...
	// Synchronized method
	 ...
	 if (balance - amt < MINBAL) throw new InsufficientBalanceException(); 
	 else {
	  balance = balance - amt; System.out.println("after withdrwing Rs." + amt + " current Balance : Rs." + balance); } }
